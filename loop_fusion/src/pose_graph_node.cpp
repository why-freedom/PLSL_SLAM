...
int main(int argc, char **argv)
{
    ...
    std::string pkg_path = "/home/why/SLAM_Fusion/PLSL-SLAM/src/plsl-slam/loop_fusion";
    ...
    ros::Subscriber sub_vio = n.subscribe("/plsl_slam/odometry", 2000, vio_callback);
    ros::Subscriber sub_image = n.subscribe(IMAGE_TOPIC, 2000, image_callback);
    ros::Subscriber sub_pose = n.subscribe("/plsl_slam/keyframe_pose", 2000, pose_callback);
    ros::Subscriber sub_extrinsic = n.subscribe("/plsl_slam/extrinsic", 2000, extrinsic_callback);
    ros::Subscriber sub_point = n.subscribe("/plsl_slam/keyframe_point", 2000, point_callback);
    ros::Subscriber sub_margin_point = n.subscribe("/plsl_slam/margin_cloud", 2000, margin_point_callback);
