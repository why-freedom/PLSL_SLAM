...
#include "../utility/line_geometry.h"  // why
#include "../aloam_velodyne/common.h"  // why
...
// ---------------- why 2021.1.7 激光点特征管理器 参照上面 --------------------
// class LidarFeaturePerFrame
// {
// public:
//     LidarFeaturePerFrame(const pcl::PointCloud<PointType> cornerPointsSharp)
//     {
//       lidarCornerPointsSharp = cornerPointsSharp;
//     }
//     pcl::PointCloud<PointType> lidarCornerPointsSharp;
// };

// class LidarFeaturePerId
// {
// public:
//     vector<LidarFeaturePerFrame> lidarfeature_per_frame;
// };
// ----------------- end --------------------------
...
class FeatureManager
{
  public:
    ...
    bool addFeatureCheckParallax(int frame_count, 
                                 ...
                                 const pcl::PointCloud<PointType>::Ptr cornerPointsSharp, // why
                                 double td);
    // stereo line
    ...
    list<lineFeaturePerId>  linefeature; // why
    // list<LidarFeaturePerId> lidarfeature;   // why for 可视化，，没啥大用 暂时
    // pcl::PointCloud<PointType> lidarfeature;
    pcl::PointCloud<PointType>::Ptr lidarfeature;//(new pcl::PointCloud<PointType>());
